...
export default function WomenAccessoriesPage() {
  const accessoriesCategories = [
    ...
    {
      title: "BELTS",
      subtitle: "Waist definition",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/accessories/belts",
    },
    {
      title: "HATS",
      subtitle: "Stylish coverage",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/accessories/hats",
    },
    {
      title: "SUNGLASSES",
      subtitle: "Chic protection",
      image: "/placeholder.svg?height=600&width=400",
    ...
    },
    {
      ...
      subtitle: "Beautiful details",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/accessories/hair",
    },
    {
      title: "GLOVES",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        <Image
          ...
          alt="Women's Accessories Collection"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-center mb-8 tracking-wider">ACCESSORIES</h1>
          <Link href="#products">
            <Button
              variant="outline"
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#jewelry" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              JEWELRY
            </Link>
            <Link href="#scarves" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              SCARVES
            </Link>
            <Link href="#belts" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              BELTS
            </Link>
            <Link href="#hats" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              HATS
            </Link>
            <Link href="#sunglasses" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              SUNGLASSES
            </Link>
      ...
      <section id="products" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-light">ACCESSORIES COLLECTION</h2>
