...
export default function MenAccessoriesPage() {
  const accessoriesCategories = [
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/accessories/ties",
    },
    {
      title: "WALLETS",
      subtitle: "Pocket essentials",
      image: "/placeholder.svg?height=600&width=400",
    ...
    {
      title: "HATS",
      subtitle: "Head coverage",
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/accessories/hats",
    },
    {
      title: "SCARVES",
      subtitle: "Warm accents",
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/accessories/scarves",
    },
    {
      title: "BAGS",
      subtitle: "Functional style",
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/accessories/bags",
    },
  ]
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#watches" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              WATCHES
            </Link>
            <Link href="#belts" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              BELTS
            </Link>
            <Link href="#ties" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              TIES
            </Link>
            <Link href="#wallets" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              WALLETS
            </Link>
