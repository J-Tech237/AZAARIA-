      ...
      <section className="py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            ...
            <Link href="/men/shoes" className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap">
              SHOES
            </Link>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#loafers" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              LOAFERS
            </Link>
            <Link href="#oxfords" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              OXFORDS
            </Link>
