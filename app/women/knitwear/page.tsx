  ...
  const knitwearCategories = [
    {
      ...
      href: "/women/knitwear/sweaters",
    },
    {
      title: "CARDIGANS",
      subtitle: "Layering essentials",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/knitwear/cardigans",
    },
    {
      title: "PULLOVERS",
      subtitle: "Easy elegance",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/knitwear/pullovers",
    },
    {
      title: "HOODIES",
      subtitle: "Casual comfort",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/knitwear/hoodies",
    },
    {
      title: "TURTLENECKS",
      subtitle: "Classic sophistication",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/knitwear/turtlenecks",
    },
    {
      title: "PONCHOS",
      subtitle: "Flowing style",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/knitwear/ponchos",
    },
    {
      title: "WRAPS",
      subtitle: "Versatile layers",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/knitwear/wraps",
    },
    {
      title: "VESTS",
      subtitle: "Sleeveless chic",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/knitwear/vests",
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        <Image
          ...
          alt="Women's Knitwear Collection"
          fill
      ...
      <section className="py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            ...
            <Link href="/women/knitwear" className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap">
              KNITWEAR
            </Link>
