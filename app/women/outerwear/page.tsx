...
export default function WomenOuterwearPage() {
  const outerwearCategories = [
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/outerwear/trench",
    },
    {
      title: "PUFFER JACKETS",
      subtitle: "Cozy insulation",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/outerwear/puffer",
    },
    {
      title: "WOOL COATS",
      subtitle: "Luxurious warmth",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/outerwear/wool",
    },
    {
      title: "LEATHER JACKETS",
      subtitle: "Edgy sophistication",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/outerwear/leather",
    },
    {
      title: "CAPES",
      subtitle: "Dramatic style",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/outerwear/capes",
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        <Image
          ...
          alt="Women's Outerwear Collection"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-center mb-8 tracking-wider">OUTERWEAR</h1>
          <Link href="#products">
            <Button
              variant="outline"
      ...
      <section className="py-4 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-black">Outerwear</span>
          </nav>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            ...
            <Link
              ...
              className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap"
            >
              OUTERWEAR
            </Link>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#coats" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              COATS
            </Link>
            <Link href="#jackets" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              JACKETS
            </Link>
            <Link href="#parkas" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              PARKAS
            </Link>
            <Link href="#trench" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              TRENCH
            </Link>
            <Link href="#puffer" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              PUFFER
            </Link>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
            {outerwearCategories.map((category) => (
      ...
      <section id="products" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-light">OUTERWEAR COLLECTION</h2>
