...
export default function WomenBlazersPage() {
  const blazersCategories = [
    {
      title: "BUSINESS BLAZERS",
      subtitle: "Professional polish",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/blazers/business",
    },
    {
      title: "CASUAL BLAZERS",
      subtitle: "Relaxed elegance",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/blazers/casual",
    },
    {
      title: "EVENING BLAZERS",
      subtitle: "Night sophistication",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/blazers/evening",
    },
    {
      title: "CROPPED BLAZERS",
      subtitle: "Modern silhouette",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/blazers/cropped",
    },
    {
      title: "OVERSIZED BLAZERS",
      subtitle: "Relaxed fit",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/blazers/oversized",
    },
    {
      title: "TEXTURED BLAZERS",
      subtitle: "Rich fabrics",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/blazers/textured",
    },
    {
      title: "PRINTED BLAZERS",
      subtitle: "Statement style",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/blazers/printed",
    },
    {
      title: "TAILORED BLAZERS",
      subtitle: "Perfect fit",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/blazers/tailored",
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        <Image
          ...
          alt="Women's Blazers Collection"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-center mb-8 tracking-wider">BLAZERS</h1>
          <Link href="#products">
            <Button
              variant="outline"
      ...
      <section className="py-4 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-black">Blazers</span>
          </nav>
        </div>
      </section>
      ...
      <section className="py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            ...
            <Link href="/women/blazers" className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap">
              BLAZERS
            </Link>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#evening" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              EVENING
            </Link>
            <Link href="#cropped" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              CROPPED
            </Link>
            <Link href="#oversized" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              OVERSIZED
            </Link>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
            {blazersCategories.map((category) => (
      ...
      <section id="products" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-light">BLAZERS COLLECTION</h2>
