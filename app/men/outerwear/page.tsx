...
export default function MenOuterwearPage() {
  const outerwearCategories = [
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/outerwear/blazers",
    },
    {
      title: "PARKAS",
      subtitle: "Weather protection",
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/outerwear/parkas",
    },
    {
      title: "PUFFER JACKETS",
      subtitle: "Insulated warmth",
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/outerwear/puffer",
    },
    {
      title: "BOMBER JACKETS",
      subtitle: "Urban style",
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/outerwear/bomber",
    },
    {
      title: "LEATHER JACKETS",
      subtitle: "Timeless edge",
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/outerwear/leather",
    },
    {
      title: "WINDBREAKERS",
      subtitle: "Light protection",
      image: "/placeholder.svg?height=600&width=400",
      href: "/men/outerwear/windbreakers",
    },
  ]
      ...
      <section className="py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            ...
            <Link href="/men/outerwear" className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap">
              OUTERWEAR
            </Link>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#bomber" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              BOMBER
            </Link>
