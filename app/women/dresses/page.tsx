...
export default function WomenDressesPage() {
  const dressCategories = [
    {
      title: "MIDI DRESSES",
      subtitle: "Elegant length",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/dresses/midi",
    },
    {
      title: "MAXI DRESSES",
      subtitle: "Floor-length grace",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/dresses/maxi",
    },
    {
      title: "MINI DRESSES",
      subtitle: "Playful & chic",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/dresses/mini",
    },
    {
      title: "COCKTAIL",
      subtitle: "Evening elegance",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/dresses/cocktail",
    },
    {
      title: "CASUAL",
      subtitle: "Everyday comfort",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/dresses/casual",
    },
    {
      title: "FORMAL",
      subtitle: "Professional style",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/dresses/formal",
    },
    {
      title: "PARTY",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-center mb-8 tracking-wider">DRESSES</h1>
          <Link href="#products">
            <Button
              variant="outline"
      ...
      <section className="py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            <Link href="/women/dresses" className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap">
              DRESSES
            </Link>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#cocktail" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              COCKTAIL
            </Link>
      ...
      <section id="products" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-light">DRESSES COLLECTION</h2>
