...
export default function WomenLingeriePage() {
  const lingerieCategories = [
    {
      title: "BRAS",
    ...
    {
      title: "UNDERWEAR",
      subtitle: "Comfortable basics",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/lingerie/underwear",
    },
    {
      title: "SHAPEWEAR",
      subtitle: "Smooth silhouettes",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/lingerie/shapewear",
    },
    {
      title: "SLEEPWEAR",
      subtitle: "Dreamy comfort",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/lingerie/sleepwear",
    },
    {
      title: "LOUNGEWEAR",
      subtitle: "Relaxed elegance",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/lingerie/loungewear",
    },
    {
      title: "HOSIERY",
      subtitle: "Leg perfection",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/lingerie/hosiery",
    },
    {
      title: "ROBES",
      subtitle: "Luxurious wraps",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/lingerie/robes",
    },
    {
      title: "SETS",
      subtitle: "Coordinated comfort",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/lingerie/sets",
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        <Image
          ...
          alt="Women's Lingerie Collection"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-center mb-8 tracking-wider">LINGERIE</h1>
          <Link href="#products">
            <Button
              variant="outline"
      ...
      <section className="py-4 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-black">Lingerie</span>
          </nav>
        </div>
      </section>
      ...
      <section className="py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            ...
            <Link href="/women/lingerie" className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap">
              LINGERIE
            </Link>
          </nav>
        </div>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#bras" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              BRAS
            </Link>
            <Link href="#underwear" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              UNDERWEAR
            </Link>
            <Link href="#shapewear" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              SHAPEWEAR
            </Link>
            <Link href="#sleepwear" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              SLEEPWEAR
            </Link>
            <Link href="#loungewear" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              LOUNGEWEAR
            </Link>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
            {lingerieCategories.map((category) => (
      ...
      <section id="products" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-light">LINGERIE COLLECTION</h2>
