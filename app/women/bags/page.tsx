...
export default function WomenBagsPage() {
  const bagsCategories = [
    ...
    {
      title: "SHOULDER BAGS",
      subtitle: "Comfortable carry",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/bags/shoulder",
    },
    {
      title: "CROSSBODY",
      subtitle: "Hands-free style",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/bags/crossbody",
    },
    {
      title: "CLUTCHES",
    ...
    {
      title: "TOTE BAGS",
      subtitle: "Spacious style",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/bags/tote",
    },
    {
      title: "MINI BAGS",
      subtitle: "Compact chic",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/bags/mini",
    },
    {
      title: "TRAVEL BAGS",
      subtitle: "Journey ready",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/bags/travel",
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-center mb-8 tracking-wider">BAGS</h1>
          <Link href="#products">
            <Button
              variant="outline"
      ...
      <section className="py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            ...
            <Link href="/women/bags" className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap">
              BAGS
            </Link>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#handbags" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              HANDBAGS
            </Link>
            <Link href="#shoulder" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              SHOULDER
            </Link>
            <Link href="#crossbody" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              CROSSBODY
            </Link>
            <Link href="#clutches" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              CLUTCHES
            </Link>
            <Link href="#backpacks" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              BACKPACKS
            </Link>
      ...
      <section id="products" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-light">BAGS COLLECTION</h2>
