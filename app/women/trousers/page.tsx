...
export default function WomenTrousersPage() {
  const trousersCategories = [
    {
      title: "WIDE LEG",
      subtitle: "Flowing elegance",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/trousers/wide-leg",
    },
    {
      title: "STRAIGHT LEG",
      subtitle: "Classic silhouette",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/trousers/straight-leg",
    },
    {
      title: "SKINNY",
      subtitle: "Sleek fit",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/trousers/skinny",
    },
    {
      title: "CROPPED",
      subtitle: "Modern length",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/trousers/cropped",
    },
    {
      title: "HIGH WAISTED",
      subtitle: "Vintage inspired",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/trousers/high-waisted",
    },
    {
      title: "PALAZZO",
      subtitle: "Dramatic flow",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/trousers/palazzo",
    },
    {
      title: "TAILORED",
      subtitle: "Professional polish",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/trousers/tailored",
    },
    {
      title: "CASUAL",
      subtitle: "Relaxed comfort",
      image: "/placeholder.svg?height=600&width=400",
      href: "/women/trousers/casual",
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        <Image
          ...
          alt="Women's Trousers Collection"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-center mb-8 tracking-wider">TROUSERS</h1>
          <Link href="#products">
            <Button
              variant="outline"
      ...
      <section className="py-4 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-black">Trousers</span>
          </nav>
        </div>
      </section>
      ...
      <section className="py-8 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-8 text-sm font-medium overflow-x-auto">
            ...
            <Link href="/women/trousers" className="hover:text-gray-600 border-b-2 border-black pb-2 whitespace-nowrap">
              TROUSERS
            </Link>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          <nav className="flex justify-center space-x-6 text-xs font-medium overflow-x-auto">
            ...
            <Link href="#wide-leg" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              WIDE LEG
            </Link>
            <Link href="#straight-leg" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              STRAIGHT LEG
            </Link>
            ...
            <Link href="#high-waisted" className="hover:text-gray-600 pb-1 whitespace-nowrap">
              HIGH WAISTED
            </Link>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
            {trousersCategories.map((category) => (
      ...
      <section id="products" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-light">TROUSERS COLLECTION</h2>
